...
DEF_UNAPPROVED_MSG = (
    ...
    "**╰━━━━━━━━━━━━━━━━━╯**\n"
    "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    f"**ANAK KONTOL ANAK NGENTOT,KALO NGECHAT MAJIKAN {DEFAULTUSER} ITU SALAM,\nHABIS ITU SABAR TUNGGU MAJIKAN GUA BALES,\nKALO GA DI BALES - BALES, LU JANGAN NYEPAM KONTOL, KAYA ANAK YATIM MAU MINTA SEMBAKO LU ANJING, APA LAGI LU NGECHAT NYA CUMA MINTA VCS, BISA GUA BLOKIR!! KALO NYEPAM JUGA TAR GUA BLOKIR!!!! TUNGGU SI {DEFAULTUSER} NERIMA PESAN LU KALO GAK LU CARI DI @FAMILYNIRVANA**\n"
    "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    "╭✠╼━━━━━━❖━━━━━━━✠╮\n"
    "┣[• 𝐁𝐎𝐓 𝐌𝐄𝐒𝐒𝐀𝐆𝐄\n"
    "┣[• 𝐁𝐘 ⛩️𝙈𝙊𝙉-𝙐𝙎𝙀𝙍𝘽𝙊𝙏⛩️\n"
